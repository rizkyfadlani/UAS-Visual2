...
begin
  ...
  begin
    ...
    begin
      Insert;
      SQL.Clear;
      SQL.Add('INSERT INTO kostumer VALUES (NULL, "' + edt1.Text + '", "' + edt2.Text + '", "' + edt3.Text + '", "' + edt4.Text + '", "' + edt5.Text + '", "' + cbb1.Text + '")');

      ExecSQL;
      SQL.Clear;
      SQL.Add('SELECT * FROM kostumer');
      Open;
    end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        zqry1.Edit;
        zqry1.FieldByName('name').AsString := edt2.Text;
...
begin
     SQL.Clear;
     SQL.Add('delete from kostumer where id="'+a+'"');
     ExecSQL;
